...
처음으로 작성해보는 회고라 4L 회고 방법론에 따라 간단하게 작성하고자한다.

#### Liked : 좋았던 점은 무엇인가?

- 처음으로 주제 설계부터 개발까지 완료한 프로젝트라 굉장히 뿌듯했다. (학부생때도 경험이 있으나 진짜로 처음이기도하고 과정, 결과 모두 만족스럽지 못한 프로젝트였다.) <br/>
  그리고 계획했던 기능을 모두 (거의 90% 이상) 구현한 점도 좋았던 점이었다.
  
#### Lacked : 아쉬웠던 점, 부족한 점은 무엇인가?

- 체계적으로 개발하고자 일정에 따른 계획도 세웠으나, 주제 선정에 생각보다 많은 시간을 소요한 점이 아쉬운 부분이었다. <br/>
  (주제 선정에 많은 시간이 걸릴 것을 예상했으나 예상보다도 더 소요되었다.) <br/>
  팀원들의 의견을 조율하고, 최대한 많은 점을 반영하고자 한 것이 시간 소요의 원인인 것 같다. 너무 욕심이 많았다. <br/>
  주제 선정 기간을 좀 단축하고 개발에 시간을 투자했다면 조금 더 만족스러운 결과물이 나왔을 것 같다.
- 내가 작성한 코드에 대해 완벽하게 숙지하지 못한 점이 아쉽다. 조금 돌아가더라도 내 것으로 소화를 하고 사용해야하는데 그러하지 못했다.

#### Learned : 배운 점은 무엇인가?

- 현업에 계시는 멘토님께 굉장히 많은 점을 배웠다. 개발 방법론이라던지, 현업에서 쓰이는 방식, 의견 조율 방법, 프로젝트 계획, Github, CI/CD 등
- 특히, 테스트 코드를 작성하는 것이 굉장히 중요하다고 깨달았다. 물론 아예 작성하지 않은 건 아니지만 마감일에 임박할 수록 마음이 급해져 테스트 코드를 작성하지 않고 코딩하는 상황이 있었다. <br/>
  코드가 길어진 만큼 눈에 들어오지 않아 더욱 문제 해결이 어려웠었다.
- 협업 시에 사용하는 툴 (GitHub, Slack, Notion)에 대해 이해도가 많이 생겼다.

#### Longed for : 앞으로 바라는 것은 무엇인가?

- 내가 사용하는 코드에 대해 좀 더 완벽한 이해와 소화가 필요하다. 이 프로젝트가 첫걸음이라고 생각한다.
- 늘어지지 않고자한다. 좀 더 부지런히 공부하고자 한다.
